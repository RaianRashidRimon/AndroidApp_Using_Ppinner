This simple android app is developed using Android Studio. This app allows the user to select a category of game from a dropdown manu and view the most popular games from the last few decades.
